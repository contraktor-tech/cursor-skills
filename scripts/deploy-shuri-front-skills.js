...
const SOURCE_DIR = path.join(__dirname, '..', 'skills-contraktor-shuri-front')
...
function printHelp() {
	console.log(`
deploy-shuri-front-skills — copia skills de skills-contraktor-shuri-front/ para <basePath>/.cursor/skills/

  npm run deploy:shuri-front -- <basePath>

  basePath: caminho da raiz do projeto de destino (ex.: /opt/projetos/shuri/shuri-front).
...
function main() {
	...
	if (!basePath) {
		...
		console.error('Uso: npm run deploy:shuri-front -- <basePath>')
		console.error('Ex.: npm run deploy:shuri-front -- /opt/projetos/shuri/shuri-front')
		process.exit(1)
	}
